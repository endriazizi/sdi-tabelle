...
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.mapper.PastoAlternativoEntityMapper;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.PastoAlternativoRepository;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.entity.PastoAlternativoEntity;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.specification.PastoAlternativoSpecification;
...
import it.iccs.simeal.sdi.configurazione.application.port.outbound.persistence.PastoAlternativoPersistence;
