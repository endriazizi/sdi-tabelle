...
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.mapper.GiroEntityMapper;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.GiroRepository;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.entity.GiroEntity;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.specification.GiroSpecification;
...
import it.iccs.simeal.sdi.configurazione.application.port.outbound.persistence.GiroPersistence;
