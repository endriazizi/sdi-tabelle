...
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.mapper.TipologiaIstitutoEntityMapper;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.TipologiaIstitutoRepository;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.entity.TipologiaIstitutoEntity;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.specification.TipologiaIstitutoSpecification;
...
import it.iccs.simeal.sdi.configurazione.application.port.outbound.persistence.TipologiaIstitutoPersistence;
