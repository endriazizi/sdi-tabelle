...
@Repository
public interface CentroCotturaIstitutoRepository extends JpaRepository<CentroCotturaIstitutoEntity, UUID>, JpaSpecificationExecutor<CentroCotturaIstitutoEntity> {
