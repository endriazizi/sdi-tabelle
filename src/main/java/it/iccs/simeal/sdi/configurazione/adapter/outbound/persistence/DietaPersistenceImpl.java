...
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.mapper.DietaEntityMapper;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.DietaRepository;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.entity.DietaEntity;
import it.iccs.simeal.sdi.configurazione.adapter.outbound.persistence.repository.specification.DietaSpecification;
...
import it.iccs.simeal.sdi.configurazione.application.port.outbound.persistence.DietaPersistence;
